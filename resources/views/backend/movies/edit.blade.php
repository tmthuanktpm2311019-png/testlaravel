...
<head>
    ...
    <title>Chỉnh sửa Phim - TVCinema</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Chỉnh sửa Phim</h1>
                            ...
                            <form action="{{ route('movies.update', $movie->movie_id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        @if ($movie->poster_url)
                                            <img src="{{ asset('storage/' . $movie->poster_url) }}" alt="Poster" width="100" class="mt-2">
                                        @endif
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        @if ($movie->bg_url)
                                            <img src="{{ asset('storage/' . $movie->bg_url) }}" alt="Background" width="100" class="mt-2">
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control" id="trailer_url" name="trailer_url" value="{{ $movie->trailer_url }}">
                                </div>
                                <div class="form-group">
                                    <label for="slug">Slug</label>
                                    <input type="text" class="form-control" id="slug" name="slug" value="{{ $movie->slug }}" required>
                                </div>
                                <div class="form-group">
