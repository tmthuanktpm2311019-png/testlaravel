...
<head>
    ...
    <title>Thêm Rạp Mới - TVCinema</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Thêm Rạp Mới</h1>
                        ...
                        <div class="card-body">
                            <form action="{{ route('theaters.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="total_screens" name="total_screens" required>
                                </div>
