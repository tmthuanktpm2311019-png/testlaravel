...
<head>
    ...
    <title>Chỉnh sửa Rạp - TVCinema</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Chỉnh sửa Rạp</h1>
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="{{ route('theaters.update', $theater->theater_id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $theater->phone_number }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="total_screens">Tổng số phòng chiếu</label>
                                    <input type="number" class="form-control" id="total_screens" name="total_screens" value="{{ $theater->total_screens }}" required>
                                </div>
