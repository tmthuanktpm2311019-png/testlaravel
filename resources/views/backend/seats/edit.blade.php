                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="room_id" name="room_id" required>
                                        @foreach($rooms as $room)
                                            <option value="{{ $room->room_id }}" {{ $seat->room_id == $room->room_id ? 'selected' : '' }}>{{ $room->name }} - {{ $room->theater->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="seat_number">Số ghế</label>
                                    <input type="number" class="form-control" id="seat_number" name="seat_number" value="{{ $seat->seat_number }}" required>
                                </div>
                                <div class="form-group">
