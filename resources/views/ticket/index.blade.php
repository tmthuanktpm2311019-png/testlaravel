                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $ticket->status }}</td>
                                        <td>
                                            <a href="{{ route('tickets.edit', $ticket->ticket_id) }}" class="btn btn-warning btn-sm">Sửa</a>
                                            <form action="{{ route('tickets.destroy', $ticket->ticket_id) }}" method="POST" style="display:inline-block">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm">Xoá</button>
                                            </form>
                                            <form action="{{ route('tickets.receive', $ticket->ticket_id) }}" method="POST" style="display:inline-block">
                                                @csrf
                                                <button type="submit" class="btn btn-success btn-sm">Nhận vé</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
