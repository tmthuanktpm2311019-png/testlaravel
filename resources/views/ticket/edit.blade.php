...
<head>
    ...
    <title>Chỉnh sửa Vé - TVCinema</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Chỉnh sửa Vé</h1>
                        ...
                        <div class="card-body">
                            <form action="{{ route('tickets.update', $ticket->ticket_id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>User ID</label>
                                    <input type="number" name="user_id" class="form-control" value="{{ $ticket->user_id }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Showtime ID</label>
                                    <input type="number" name="showtime_id" class="form-control" value="{{ $ticket->showtime_id }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Seat ID</label>
                                    <input type="number" name="seat_id" class="form-control" value="{{ $ticket->seat_id }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Giá</label>
